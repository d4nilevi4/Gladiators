...
{
    #region DEN
    //private const string RATING_KEY = "RateDen.RatingStatus21";
    ...
    #region Remembrance
    //private const string RATING_KEY = "RateRemembrance.RatingStatus21";
    ...
    #region IMAP
    //private const string RATING_KEY = "RateIMaps.RatingStatus21";
    ...
    #region Lite
    private const string RATING_KEY = "RateUAILite.RatingStatus21";
    ...
    #region Ultimate
    //private const string RATING_KEY = "RateUAIUltimate.RatingStatus21";
    ...
    #region SmartObjects
    //private const string RATING_KEY = "RateSmartObjects.RatingStatus21";
    //private const string ASSET_URL = "https://assetstore.unity.com/packages/slug/235906";
    ...
    private void OnGUI()
    {
        ...
        if (GUILayout.Button("Ultimate version, view and wish list or buy"))
        {
            // Open the Asset Store link in the browser
            Application.OpenURL("https://assetstore.unity.com/packages/slug/235906");
        }
