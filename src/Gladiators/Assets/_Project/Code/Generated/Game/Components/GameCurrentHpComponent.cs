...
public partial class GameEntity {
    ...
    public Gladiators.Gameplay.Lifetime.CurrentHp currentHp { get { return (Gladiators.Gameplay.Lifetime.CurrentHp)GetComponent(GameComponentsLookup.CurrentHp); } }
    ...
    public GameEntity AddCurrentHp(float newValue) {
        ...
        var component = (Gladiators.Gameplay.Lifetime.CurrentHp)CreateComponent(index, typeof(Gladiators.Gameplay.Lifetime.CurrentHp));
